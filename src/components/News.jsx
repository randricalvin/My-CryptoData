      ...
      <section className="bg-white lg:w-5/6">
          <div className="px-6 py-5">
              <div className="lg:-mx-6 lg:flex lg:items-center lg:justify-around">
                  <img className="object-cover w-full lg: lg:w-1/3 rounded-xl lg:h-64" src={image}alt={title}/>
                  <div className="mt-6 lg:w-1/2 lg:mt-0 lg:mx-6 ">
                      <h1 className="block mt-4 lg:text-2xl font-semibold md:text-xl">
                          {title}
                      </h1>
                        <h2 className="font-extrabold my-4 text-[#201E50]">
                            {origin}
                        </h2>  
                      <p className="my-5 lg:text-lg text-justify md:text-sm">
