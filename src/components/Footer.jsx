...
const Footer = () => {
  ...
  return (
    <div className='flex justify-between items-center h-20 sticky bg-[#201E50] text-white text-lg font-sans'>
        {/* get the image, the name, and the price of the first three elements */}
